...
# Configure GitLab Package Registry authentication for NuGet
# Usage: ./configure-gitlab-nuget.sh [--user <username>] [--token <token>] [--config <path>]
#
# Options:
#   --user <username>    GitLab username
#   --token <token>      GitLab PAT (scope: read_api)
...
#
# Example:
#   ./configure-gitlab-nuget.sh --user "myuser" --token "glpat-xxx" --config nuget.config
