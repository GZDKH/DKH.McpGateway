...
| **StorefrontPublic/** | **per-tenant public** — storefront_list_catalogs, storefront_get_category_tree, storefront_get_product, storefront_search_products, storefront_recommend_products (5) | StorefrontService + ProductCatalogService + SearchService |
