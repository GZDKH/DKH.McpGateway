...
public static class ManageManufacturerTool
{
    [McpServerTool(Name = "manage_manufacturer"), Description(
        "Manage manufacturers: create, update, upsert, delete, get, or list. " +
        "For create/update/upsert: provide manufacturer JSON with fields: code, displayOrder, published, " +
    ...
    public static async Task<string> ExecuteAsync(
        ...
        [Description("Manufacturer JSON (for create/update/upsert)")] string? json = null,
        ...
        IApiKeyContext ctx, string action, string? json, CancellationToken ct)
    {
        ...
        var data = McpProtoHelper.Parser.Parse<ManufacturerData>(json);
        var request = new ManageManufacturerRequest { Data = data };
