...
public static class ManageStateProvinceTypeTool
{
    [McpServerTool(Name = "manage_state_province_type"), Description(
        "Manage state/province types: create, update, delete, get, or list. " +
        "For create/update: provide state province type JSON with fields: code, displayOrder, " +
    ...
    public static async Task<string> ExecuteAsync(
        ...
        [Description("State province type JSON (for create/update)")] string? json = null,
