...
public static class ManageDeliveryTimeTool
{
    [McpServerTool(Name = "manage_delivery_time"), Description(
        "Manage delivery times: create, update, delete, get, or list. " +
        "For create/update: provide delivery time JSON with fields: code, color, isDefault, " +
    ...
    public static async Task<string> ExecuteAsync(
        ...
        [Description("Delivery time JSON (for create/update)")] string? json = null,
        ...
        IApiKeyContext ctx, string action, string? json, CancellationToken ct)
    {
        ...
        var data = McpProtoHelper.Parser.Parse<DeliveryTimeModel>(json);
