...
public static class ManageQuantityUnitTool
{
    [McpServerTool(Name = "manage_quantity_unit"), Description(
        "Manage quantity units: create, update, upsert, delete, get, or list. " +
        "For create/update/upsert: provide quantity unit JSON with fields: code, isDefault, " +
    ...
    public static async Task<string> ExecuteAsync(
        ...
        [Description("Quantity unit JSON (for create/update/upsert)")] string? json = null,
