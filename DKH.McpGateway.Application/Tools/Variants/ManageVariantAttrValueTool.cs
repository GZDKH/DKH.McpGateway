...
public static class ManageVariantAttrValueTool
{
    [McpServerTool(Name = "manage_variant_attr_value"), Description(
        "Manage variant attribute values: create, update, upsert, delete, get, or list. " +
        "For create/update/upsert: provide variant attribute value JSON with fields: productCode, productAttributeCode, " +
    ...
    public static async Task<string> ExecuteAsync(
        ...
        [Description("Variant attribute value JSON (for create/update/upsert)")] string? json = null,
        ...
        IApiKeyContext ctx, string action, string? json, CancellationToken ct)
    {
        ...
        var data = McpProtoHelper.Parser.Parse<VariantAttrValueData>(json);
        var request = new ManageVariantAttrValueRequest { Data = data };
