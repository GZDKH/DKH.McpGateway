...
[McpServerToolType]
public static class UpdateSourcingOfferTool
{
    [McpServerTool(Name = "update_sourcing_offer"), Description(
        "Update an existing sourcing offer. All scalar and collection fields are fully replaced. " +
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var request = new UpdateSourcingOfferRequest
        {
            Id = new GuidValue(id),
        ...
        var offer = await client.UpdateSourcingOfferAsync(request, cancellationToken: cancellationToken);
