...
public static class ManageSpecGroupTool
{
    [McpServerTool(Name = "manage_spec_group"), Description(
        "Manage specification groups: create, update, upsert, delete, get, or list. " +
        "For create/update/upsert: provide spec group JSON with fields: code, iconName, displayOrder, published, " +
    ...
    public static async Task<string> ExecuteAsync(
        ...
        [Description("Spec group JSON (for create/update/upsert)")] string? json = null,
        ...
        IApiKeyContext ctx, string action, string? json, CancellationToken ct)
    {
        ...
        var data = McpProtoHelper.Parser.Parse<SpecGroupData>(json);
        var request = new ManageSpecGroupRequest { Data = data };
