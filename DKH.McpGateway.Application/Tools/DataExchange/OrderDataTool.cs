...
using ExportRequest = DKH.OrderService.Contracts.Order.Api.DataExchange.v1.ExportRequest;
using GetImportTemplateRequest = DKH.OrderService.Contracts.Order.Api.DataExchange.v1.GetImportTemplateRequest;
using ImportOptions = DKH.OrderService.Contracts.Order.Api.DataExchange.v1.ImportOptions;
using ImportRequest = DKH.OrderService.Contracts.Order.Api.DataExchange.v1.ImportRequest;
...
using ValidateImportRequest = DKH.OrderService.Contracts.Order.Api.DataExchange.v1.ValidateImportRequest;

namespace DKH.McpGateway.Application.Tools.DataExchange;

[McpServerToolType]
public static class OrderDataTool
{
    [McpServerTool(Name = "order_data"), Description(
        "Bulk import/export order data. " +
    ...
    public static async Task<string> ExecuteAsync(
        ...
        OrderDataExchangeClient client,
        [Description("Action: import, export, validate, or template")] string action,
        [Description("Data profile: orders")] string profile,
        ...
        [Description("Search filter for export (matches order number)")] string? search = null,
        [Description("Status filter: Pending, Confirmed, or Completed (for export)")] string? status = null,
